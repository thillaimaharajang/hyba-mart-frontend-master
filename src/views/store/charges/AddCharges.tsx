...
const AddCharges: React.FC = () => {
    ...
    const onCreateCharges = async (event: any) => {
        event.preventDefault();
        ...
        if (chargesStore?.isValidCreateChargesForm()) {
            isValidForm = true;
            await ChargesHelper(navigate).CreateCharges();
...
export default observer(AddCharges);
