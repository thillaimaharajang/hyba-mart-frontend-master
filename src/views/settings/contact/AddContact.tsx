...
const AddContact: React.FC = () => {
    ...
    const onSubmitCreateContact = async (event: any) => {
        event.preventDefault();
        ...
        if (contactStore?.isValidCreateContactForm()) {
            isValidForm = true;
            await ContactHelper(navigate).CreateContact();
    ...
    return <PageTransition>
        <form onSubmit={onSubmitCreateContact}>
            ...
            <div className="row mt-3">
                <div className="col-4">
                    <Button htmlType='submit' className="custom-btn" type="primary" onClick={onSubmitCreateContact}>CREATE</Button>
                </div>
            </div>
